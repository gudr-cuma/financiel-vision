...
const MODULES = [
  ...
  },
  {
    ...
    color: '#B45309',
    bg: '#FFF7E6',
    description: 'Gérez le tableau d\'amortissement de vos emprunts et leur impact sur la trésorerie.',
  },
  {
    id: 'immobilisations',
    icon: '🏗️',
    ...
    color: '#475569',
    bg: '#F1F5F9',
    description: 'Suivez le registre des immobilisations et leurs amortissements.',
  },
  {
    id: 'capitalSocialRegistre',
    icon: '🪙',
    label: 'Capital social',
    color: '#CA8A04',
    bg: '#FEFCE8',
    description: 'Gérez le registre des parts sociales et mouvements de capital des adhérents.',
  },
  {
    id: 'materiels',
    icon: '🚜',
    ...
    color: '#15803D',
    bg: '#ECFDF3',
    description: 'Analysez les coûts et l\'usage de votre parc matériel.',
  },
  {
    id: 'ficheSynthese',
    icon: '🗂️',
    ...
    color: '#7C3AED',
    bg: '#F5F0FF',
    description: 'Consultez la fiche de synthèse consolidée de l\'exercice.',
  },
  {
    id: 'editions',
    icon: '📒',
