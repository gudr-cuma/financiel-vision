...
export function makeFooter(currentPage, pageCount) {
  return {
    columns: [
      { text: 'Financiel Vision', fontSize: 7, color: COLORS.secondary, margin: [40, 0, 0, 0] },
...
export function makeCoverPage(parsedFec, selectedDocs, DOC_LABELS) {
  ...
  return [
    ...
    {
      stack: [
        { text: 'Financiel Vision', fontSize: 32, bold: true, color: COLORS.primary, margin: [0, 80, 0, 4] },
